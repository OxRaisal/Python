...
bot_sweet = 0
def start_game():
    print('Условие задачи: На столе лежит 193 конфеты. Играют два игрока делая ход друг после друга.\n Первый ход определяется жеребьёвкой.\n За один ход можно забрать не более чем 28 конфет.\n Все конфеты оппонента достаются сделавшему последний ход.')
    who_is_first()
...
def player_turn():
    ...
    while take_sweet > 28 or take_sweet < 0 or take_sweet > total_sweet:
        take_sweet = int(input('Вы берете неверное количество конфет! попробуйте снова:'))
